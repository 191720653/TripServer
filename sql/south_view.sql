...
CREATE TABLE `other` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '名人典故、名点美食、民品民俗主键',
  ...
  `urls` varchar(300) DEFAULT NULL COMMENT '图片地址',
  `type` varchar(1) DEFAULT NULL COMMENT '信息类型：1名人典故，2名点美食，3民品民俗',
  `create_data` date DEFAULT NULL COMMENT '创建时间',
  `remark` varchar(200) DEFAULT NULL COMMENT '备注',
  `text` varchar(300) DEFAULT NULL COMMENT '保留字段',
  `record` varchar(300) DEFAULT NULL COMMENT '保留字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `other` */

insert  into `other`(`id`,`name`,`info`,`logo`,`like_num`,`urls`,`type`,`create_data`,`remark`,`text`,`record`) values (1,'123','123','./photoes/1462101744572.jpg',128,'[\"./photoes/1462102077765.jpg\"]','1','2016-05-01','123',NULL,NULL),(2,'456','456','./photoes/1462101763452.jpg',456,'[\"./photoes/1462102453689.jpg\"]','2','2016-05-01','456',NULL,NULL),(3,'789','789','./photoes/1462101774991.jpg',789,'[\"./photoes/1462102461419.jpg\"]','3','2016-05-01','789',NULL,NULL),(4,'123123','123123','./photoes/1462102176775.jpg',123123,'[\"./photoes/1462102225544.jpg\"]','1','2016-05-01','123123',NULL,NULL);
...
CREATE TABLE `trip_info` (
  `trip_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '旅游Id',
  `type_id` int(11) DEFAULT NULL COMMENT '旅游类型Id',
  `trip_title` varchar(100) DEFAULT NULL COMMENT '旅游标题',
  `trip_content` varchar(200) DEFAULT NULL COMMENT '旅游描述',
  `trip_logo` varchar(200) DEFAULT NULL COMMENT '旅游图标',
  `remark` varchar(100) DEFAULT NULL COMMENT '旅游备注',
  PRIMARY KEY (`trip_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `trip_info` */

insert  into `trip_info`(`trip_id`,`type_id`,`trip_title`,`trip_content`,`trip_logo`,`remark`) values (1,2,'亲子一日游','亲子一日游的路线!','./photoes/1460281545012.jpg','亲子一日游的备注!'),(2,3,'暑假全家游','暑假全家游的路线','./photoes/1460281557067.jpg','暑假全家游的备注');
...
CREATE TABLE `trip_type` (
  `type_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '旅游类型id',
  `type_title` varchar(200) DEFAULT NULL COMMENT '旅游类型标题',
  `type_logo` varchar(200) DEFAULT NULL COMMENT '旅游类型图标',
  `remark` varchar(100) DEFAULT NULL COMMENT '旅游类型备注',
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `trip_type` */

insert  into `trip_type`(`type_id`,`type_title`,`type_logo`,`remark`) values (2,'一日游','./photoes/1460278253351.jpg','一日游类型'),(3,'暑假游','./photoes/1460278260698.jpg','暑假游类型'),(4,'节假游','./photoes/1460279294346.jpg','节假游');
...
insert  into `village`(`village_id`,`village_name`,`village_address`,`village_info`,`village_logo`,`history_record`,`village_story`,`like_num`,`create_date`,`remark`) values (6,'良都','中山市良都','中山市良都中学位于人杰地灵、名人辈出的中山市重点侨乡——南区。学校初创于1956年，办学历史上经过三次合并和较大规模的布局调整，2003年由原良都初级中学和南区职业中学合并。','./photoes/1457963511671.jpg','中山市良都中学位于人杰地灵、名人辈出的中山市重点侨乡——南区。学校初创于1956年，办学历史上经过三次合并和较大规模的布局调整，2003年由原良都初级中学和南区职业中学合并。','中山市良都中学位于人杰地灵、名人辈出的中山市重点侨乡——南区。学校初创于1956年，办学历史上经过三次合并和较大规模的布局调整，2003年由原良都初级中学和南区职业中学合并。',6,'2016-03-12','2016-03-12'),(7,'马岭','中山市马岭','马岭社区位于南区中部，东与五桂山交界接壤，南至北台社区，西与八乡一山相隔，北邻沙涌社区，由原龙环、芦溪、羊寮、板桥、梅坪五个自然村组成，辖区面积约7.7平方公里，常住人口1600人，流动人口1400多人，于2006年“村改居”转为社区居民委员会。','./photoes/1457963524348.jpg','马岭社区位于南区中部，东与五桂山交界接壤，南至北台社区，西与八乡一山相隔，北邻沙涌社区，由原龙环、芦溪、羊寮、板桥、梅坪五个自然村组成，辖区面积约7.7平方公里，常住人口1600人，流动人口1400多人，于2006年“村改居”转为社区居民委员会。','马岭社区位于南区中部，东与五桂山交界接壤，南至北台社区，西与八乡一山相隔，北邻沙涌社区，由原龙环、芦溪、羊寮、板桥、梅坪五个自然村组成，辖区面积约7.7平方公里，常住人口1600人，流动人口1400多人，于2006年“村改居”转为社区居民委员会。',2,'2016-03-12','2016-03-12'),(8,'城南','中山城南','中山市南区城南社区居民委员会位于地址,交通便利，我们这里物产丰富，人杰地灵，百姓和谐。在上级部门的关怀下，这里干群关系融洽，社会稳定，经济发展，热情欢迎各级领导前来指导。也欢迎社会各界前来投资兴业。','./photoes/1457963535181.jpg','中山市南区城南社区居民委员会位于地址,交通便利，我们这里物产丰富，人杰地灵，百姓和谐。在上级部门的关怀下，这里干群关系融洽，社会稳定，经济发展，热情欢迎各级领导前来指导。也欢迎社会各界前来投资兴业。','中山市南区城南社区居民委员会位于地址,交通便利，我们这里物产丰富，人杰地灵，百姓和谐。在上级部门的关怀下，这里干群关系融洽，社会稳定，经济发展，热情欢迎各级领导前来指导。也欢迎社会各界前来投资兴业。',6,'2016-03-12','2016-03-12'),(9,'北溪','中山北溪','在碧波荡漾的北溪河畔，绿树掩映着一排树皮盖顶，竹木结构的小屋，迎风招展的彩旗给这个古朴雅致的场所增添了几分喜庆的氛围！元月一日，北溪水寨将正式对外试营业，走在青砖铺就的百米小街上，让人有了亲切的温馨感的同时，就有了品尝美食的渴望！','./photoes/1457963549243.jpg','在碧波荡漾的北溪河畔，绿树掩映着一排树皮盖顶，竹木结构的小屋，迎风招展的彩旗给这个古朴雅致的场所增添了几分喜庆的氛围！元月一日，北溪水寨将正式对外试营业，走在青砖铺就的百米小街上，让人有了亲切的温馨感的同时，就有了品尝美食的渴望！','在碧波荡漾的北溪河畔，绿树掩映着一排树皮盖顶，竹木结构的小屋，迎风招展的彩旗给这个古朴雅致的场所增添了几分喜庆的氛围！元月一日，北溪水寨将正式对外试营业，走在青砖铺就的百米小街上，让人有了亲切的温馨感的同时，就有了品尝美食的渴望！',2,'2016-03-12','2016-03-12');
